...
class OryzaI18n {
  static const OryzaStrings pt = OryzaStrings(
    ...
    sysClientSubtitle: "Visualização agronômica responsiva (apps/local & apps/cloud)",
    ...
    pipe02Desc: "Leitura cíclica da sonda de solo 7-em-1 (NPK, pH, umidade, EC), transmissor de lâmina d'água, sensor de temperatura/umidade SHT e radiação solar incidente.",
    pipe03Title: "03. Acúmulo de Graus-Dia (GDD)",
    pipe03Desc: "Integração contínua da curva térmica diária GDD = max(0, T_media - T_base) e amplitude térmica diurna (DTR) para determinação do avanço biológico.",
    ...
    tccSubtitle: "Trabalho de Conclusão de Curso desenvolvido na Escola Superior de Agricultura Luiz de Queiroz (Universidade de São Paulo, Piracicaba).",
    ...
    authPassword: "Chave de Acesso / Senha",
    authRole: "Tipo de Credencial",
    authRoleFarmer: "Produtor Rural (Lavouras de Arroz)",
    authRoleResearcher: "Pesquisador / Agrônomo (USP / ESALQ)",
  ...
  static const OryzaStrings en = OryzaStrings(
    ...
    sysClientSubtitle: "Responsive agronomic visualization (apps/local & apps/cloud)",
    ...
    pipe03Desc: "Continuous integration of daily thermal curve GDD = max(0, T_mean - T_base) and diurnal temperature range (DTR) tracking physiological progress.",
    ...
    hwToggleBlueprint: "CAD BLUEPRINT (Orthographic & Dimensions)",
    hwToggleExploded: "3D EXPLODED VIEW (Assembly & Parts)",
    ...
    tccSubtitle: "Undergraduate thesis research conducted at Luiz de Queiroz College of Agriculture (University of São Paulo, Piracicaba).",
    ...
    authPassword: "Access Key / Password",
  ...
  static const OryzaStrings th = OryzaStrings(
    ...
    hwToggleBlueprint: "แบบร่าง CAD (ภาพฉายและขนาด)",
    hwToggleExploded: "ภาพจำลองชิ้นส่วน 3D (การประกอบและชิ้นส่วน)",
    hwZoomBtn: "ขยายแบบร่างทางเทคนิค",
    hwAiDisclaimer: "ภาพร่างแนวคิดต้นแบบสร้างด้วยความช่วยเหลือของ AI • มาตราส่วน 1:1",

    tccTitle: "งานวิจัยทางวิทยาศาสตร์และปริญญานิพนธ์ — USP / ESALQ",
    tccSubtitle: "งานวิจัยปริญญานิพนธ์ ณ วิทยาลัยเกษตรศาสตร์ Luiz de Queiroz มหาวิทยาลัยเซาเปาโล (USP, Piracicaba)",
    ...
    authPassword: "รหัสผ่าน / คีย์เข้าถึง",
    authRole: "ประเภทบัญชี",
    authRoleFarmer: "เกษตรกรชาวนา",
    authRoleResearcher: "นักวิจัย / นักปฐพีวิทยา (USP / ESALQ)",
