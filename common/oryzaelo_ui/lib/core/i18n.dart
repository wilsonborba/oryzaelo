...
class OryzaI18n {
  static const OryzaStrings pt = OryzaStrings(
    ...
    benchmarkQuote1Author: "Remote Sensing of Environment (Elsevier)",
    benchmarkQuote1Role: "Artigo Científico Peer-Reviewed • DOI: 10.1016/j.rse.2017.03.029",
    ...
    benchmarkQuote1Source: "Remote Sensing of Environment (2017) • Vol. 194, pp. 347–365",
    benchmarkQuote1Url: "https://doi.org/10.1016/j.rse.2017.03.029",
    ...
    howToUseLocalStep1Tip: "O instalador armazena os binários em /opt/oryzaelo_engine/bin/, a interface em /opt/oryzaelo_engine/web/ e o arquivo de configuração em /opt/oryzaelo_engine/.env. É compatível com arquiteturas ARM64 (Raspberry Pi 4/5, Zero 2W) e x86_64.",
    howToUseLocalStep2Snippet: "# Raspberry Pi OS / Debian / Ubuntu / Arch (systemd):\nsudo systemctl enable --now oryzaelo_engine\n\n# Verificar status do motor de borda:\nsudo systemctl status oryzaelo_engine",
  ...
  static const OryzaStrings en = OryzaStrings(
    ...
    benchmarkQuote1Author: "Remote Sensing of Environment (Elsevier)",
    benchmarkQuote1Role: "Peer-Reviewed Journal Article • DOI: 10.1016/j.rse.2017.03.029",
    ...
    howToUseLocalStep1Tip: "The installer places binaries in /opt/oryzaelo_engine/bin/, the web UI in /opt/oryzaelo_engine/web/, and configuration in /opt/oryzaelo_engine/.env. Compatible with ARM64 (Raspberry Pi 4/5, Zero 2W) and x86_64 architectures.",
  ...
  static const OryzaStrings th = OryzaStrings(
    ...
    benchmarkQuote1Author: "Remote Sensing of Environment (Elsevier)",
    benchmarkQuote1Role: "บทความวิจัยที่ผ่านการประเมินทางวิชาการ • DOI: 10.1016/j.rse.2017.03.029",
    ...
    benchmarkQuote1Source: "Remote Sensing of Environment (2017) • เล่มที่ 194, หน้า 347–365",
    benchmarkQuote1Url: "https://doi.org/10.1016/j.rse.2017.03.029",
    benchmarkQuote2Author: "Tract Neural Engine (Sonos Open Source)",
    ...
    howToUseLocalStep1Tip: "ตัวติดตั้งจะเก็บไบนารีไว้ใน /opt/oryzaelo_engine/bin/ เว็บ UI ใน /opt/oryzaelo_engine/web/ และไฟล์การกำหนดค่าใน /opt/oryzaelo_engine/.env รองรับทั้งสถาปัตยกรรม ARM64 (Raspberry Pi 4/5, Zero 2W) และ x86_64",
